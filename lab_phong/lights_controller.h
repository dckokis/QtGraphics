...
inline void set_coordinates_selector(QGridLayout* layout, const lights_type lightType, const CubeWidget* cubeWidget)    
{
    ...
    case lights_type::DIRECTED:
        QObject::connect(x_coordinate_selector, &QDoubleSpinBox::valueChanged, cubeWidget, &CubeWidget::setDirectedLightX);
        QObject::connect(y_coordinate_selector, &QDoubleSpinBox::valueChanged, cubeWidget, &CubeWidget::setDirectedLightY);
        QObject::connect(z_coordinate_selector, &QDoubleSpinBox::valueChanged, cubeWidget, &CubeWidget::setDirectedLightZ);
        start_position = cubeWidget->getDirectedStartPos();
        break;
	
	case lights_type::PROJECTOR:
        QObject::connect(x_coordinate_selector, &QDoubleSpinBox::valueChanged, cubeWidget, &CubeWidget::setProjectorLightX);
        QObject::connect(y_coordinate_selector, &QDoubleSpinBox::valueChanged, cubeWidget, &CubeWidget::setProjectorLightY);
        QObject::connect(z_coordinate_selector, &QDoubleSpinBox::valueChanged, cubeWidget, &CubeWidget::setProjectorLightZ);
...
inline void set_switch(QCheckBox* switcher, const lights_type light, const CubeWidget* cubeWidget)
{
...
inline auto set_up_controller(const CubeWidget* cubeWidget, const QPalette& palette) -> QWidget*
{
    ...
    QObject::connect(ambient_color_dialog, &QColorDialog::currentColorChanged, cubeWidget, &CubeWidget::setAmbientColor);
    ...
    QObject::connect(directed_color_dialog, &QColorDialog::currentColorChanged, cubeWidget, &CubeWidget::setDirectedLightColor);
    ...
    QObject::connect(point_color_dialog, &QColorDialog::currentColorChanged, cubeWidget, &CubeWidget::setPointLightColor);
    ...
    QObject::connect(projector_color_dialog, &QColorDialog::currentColorChanged, cubeWidget, &CubeWidget::setProjectorColor);
	    /*
	     * point light
	     */
