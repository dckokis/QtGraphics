...
auto main(int argc, char* argv[]) -> int {
	...
	main_window->setWindowTitle("Guro-Phong Application");
	main_window->setWindowFlag(Qt::FramelessWindowHint);


	auto* shader_switch_button = new QPushButton("Switch Shader");
	QObject::connect(shader_switch_button, &QAbstractButton::clicked, cube_widget, &CubeWidget::switchShaderType);
	layout->addWidget(shader_switch_button, 3, 2);
